...
const SummaryItem = ({ title, value, series, colors }: PieChartProps) => {
  return (
    <div className=" background-light800_dark400 flex flex-1 flex-col items-start justify-start rounded py-[13px] pl-8 text-left  shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)]">
